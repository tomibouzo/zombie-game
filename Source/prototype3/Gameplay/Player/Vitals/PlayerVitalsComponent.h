...
public:
	...
	/** Initializes resources from the character's Blueprint-compatible configuration. */
	void InitializeVitals(float InMaxHealth, float InMaxStamina,
	...
	/** Recovers stamina for this frame, respecting the delay and exhaustion threshold. */
