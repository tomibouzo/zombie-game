...
#include "Legacy/Shooter/ShooterPlayerController.h"
#include "EnhancedInputSubsystems.h"
#include "Engine/LocalPlayer.h"
#include "InputMappingContext.h"
#include "Kismet/GameplayStatics.h"
#include "GameFramework/PlayerStart.h"
#include "Gameplay/Combat/Characters/ShooterCharacter.h"
#include "UI/Legacy/ShooterBulletCounterUI.h"
...
void AShooterPlayerController::SetupInputComponent()
{
	...
	if (IsLocalPlayerController())
	{
		...
		if (BulletCounterUI)
		{
			...
			UE_LOG(Logprototype3, Error, TEXT("Could not spawn bullet counter widget."));
